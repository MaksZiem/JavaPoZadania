...
public class Swing extends JFrame {
    ...
    public Swing() {
        ...
        menuItemEdit.addActionListener(e -> {
            ...
            if (index > -1) {
                ...
                editTask.run(title, priority);
            }
        });

        newTaskButton.addActionListener(e -> editTask.run("", ""));
    ...
    public static void main(String[] args) {
        firstListData.add(new Task("Zmywanie", "Zmywanie naczyn", "Low"));
        toDo.addElement("Zmywanie");
        secondListData.add(new Task("Sprzatanie", "Posprzatanie mieszkania",  "High"));
        progress.addElement("Sprzatanie");
        thirdListData.add(new Task("Praca domowa", "Odrob zadania na uczelnie", "High"));
